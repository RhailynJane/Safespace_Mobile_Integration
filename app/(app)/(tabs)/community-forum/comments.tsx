  ...
  3: [
    {
      ...
      content: "Great tips! I also find that limiting screen time before bed helps.",
      timestamp: "1 hour ago",
      likes: 4
    },
    {
      ...
      content: "I started practicing gratitude too and it's amazing how it changes your perspective!",
...
export default function CommentsScreen() {
  ...
  const [comments, setComments] = useState<CommentType[]>(POST_COMMENTS[numericPostId] || []);
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          <Text style={styles.errorText}>Post not found (ID: {numericPostId})</Text>
        ...
        <View style={styles.postCard}>
          <View style={styles.postHeader}>
            ...
            <View>
              ...
              <Text style={styles.postUserStats}>{post.user.posts} posts</Text>
            </View>
          </View>
